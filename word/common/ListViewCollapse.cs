...
namespace meiyu.common
{
    /// <summary>
    /// 失去焦点后保持选中行高亮
    /// http://blog.csdn.net/svtme/article/details/38559331
    /// </summary>
    ...
    /// 
    /*
            ListViewCollapse lvc = new ListViewCollapse();
            this.panel_choose.Controls.Add(lvc);
            
            lvc.Width = 780;            

            ListViewGroup lvg = lvc.Groups.Add("group1", "国内考试");
            lvc.SetGroupState(ListViewGroupState.Collapsible | ListViewGroupState.SubSeted);           
            //lvc.Items.AddRange(item1, item2);
            ListViewItem item1 =lvc.Items.Add("四级", 0);
            item1.SubItems.Add("1");
            item1.SubItems.Add("2");
            item1.SubItems.Add("3");
            ListViewItem item2 = lvc.Items.Add("六级", 0);
            ...
            item2.Group = lvg;      
             * */
    /// https://www.codeproject.com/script/Membership/LogOn.aspx?rp=http%3a%2f%2fwww.codeproject.com%2fArticles%2f36775%2fCollapsible-ListViewGroup&download=true
    /// </summary>
